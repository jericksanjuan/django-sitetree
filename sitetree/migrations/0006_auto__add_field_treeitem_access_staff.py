...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TreeItem.access_staff'
        db.add_column(u'sitetree_treeitem', 'access_staff',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TreeItem.access_staff'
        db.delete_column(u'sitetree_treeitem', 'access_staff')
    ...
    models = {
        ...
        u'sitetree.treeitem': {
            ...
            'access_staff': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'}),
